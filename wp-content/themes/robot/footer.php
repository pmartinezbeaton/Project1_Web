		...
		<div class='footer_txt'>
			<div class='container'>
				...
				<?php /*
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/robot/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://smthemes.com/' target='_blank'>SMThemes.com</a>, thanks to: <a href='http://crocotheme.com/' target='_blank'>Free WordPress themes</a>, <a href='http://rus-business.com' target='_blank'>Rus Business</a> and <a href='http://www.dpthemes.com/' target='_blank'>dpThemes</a></div>
			</div>
		</div>
		<?php wp_footer(); ?>
	</div> <?php //footer ?>
