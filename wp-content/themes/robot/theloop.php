		...
		?>
			...
			if (!is_page()) {?><p class='post-meta'>
				...
				if(comments_open( get_the_ID() ))  {
                    ?>  <span class='post-date'><?php echo get_the_date(); ?></span> <span class='post-comments'><?php comments_popup_link( $SMTheme->_( 'noresponses' ), $SMTheme->_( 'oneresponse' ), $SMTheme->_( 'multiresponse' ) ); ?></span>
				<?php }
