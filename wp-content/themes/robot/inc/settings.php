<?php
    ...
    $settings = array(
		...
		'slider'=>array(
			...
			'content'=>array(
				'txt'=>array(
					'type'=>'p','name'=>'','value'=>'Recommended thumbnail size is 1000x380px'
				),
				'source'=>array(
		...
		'layout'=>array(
			...
			'content'=>array(
				...
				'cuttxt'=>array(
					'type'=>'text','name'=>'cuttxt','value'=>'390','ttl'=>'Length of content in the feed', 'hint'=>'If value more then 0, post in the feed, without excerpt and "read more" tag, will be cutted to that number of chars.'
				),
				'imgwidth'=>array(
